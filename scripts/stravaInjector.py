"""
fit2gpx - a project by dodsaba
https://github.com/dodo-saba/fit2gpx

Tuned for my usage:
- Enriched desc with metadata (time, speed, elevation)
- Allowed emoji and french accents
- Changed elevation column access name
"""
...
class Converter:
    ...
    def dataframe_to_gpx(self, df_points, col_lat='latitude', col_long='longitude', col_time=None, col_alt=None,
        ...
        gpx_track.add_elevation(100000000)
...
#DIR_STRAVA = "/Users/mathieuguyot/Downloads/export-strava/"
DIR_STRAVA="/Users/mathieuguyot/Downloads/export-strava/"
